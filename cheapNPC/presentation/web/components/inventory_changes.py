"""
Inventory Changes component for the CheapNPC dashboard.

This component displays inventory comparison between initial and current states,
...
class InventoryChangesComponent(BaseComponent):
    """Component for displaying inventory changes."""
