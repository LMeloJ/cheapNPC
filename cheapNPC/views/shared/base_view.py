...
This class provides common functionality for all views in the MVC pattern.
"""
...
from cheapNPC.services.inventory_service import InventoryService
...
class BaseView(ABC):
    ...
    def __init__(self):
        """Initialize the view with lazy service loading."""
    ...
    def create_interface(self) -> gr.Blocks:
        """Create the Gradio interface for this view."""
        pass
