"""
Agent Operations view for cheapNPC MVC architecture.

This view handles all AI agent operations including:
...
from cheapNPC.models.npcs import SalesPersonProfession, CraftAndGatherProfessions
from cheapNPC.agents.generator_agent import (
    SalesPersonNPCGeneratorAgent, 
    CrafterNPCGeneratorAgent
)
from cheapNPC.agents.planner_agent import PlannerAgent
from cheapNPC.agents.trader_agent import TraderAgent

from cheapNPC.views.shared.base_view import BaseView


class AgentOperationsView(BaseView):
    """View for handling AI agent operations."""
    
    def __init__(self):
        """Initialize the agent operations view."""
        super().__init__()
