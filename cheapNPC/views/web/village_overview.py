"""
Village Overview view for cheapNPC MVC architecture.

This view displays an overview of all NPCs in the village,
...
class VillageOverviewView(BaseView):
    """View for displaying village NPC overview."""
